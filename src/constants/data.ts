...
export const getDeptTheme = (deptId: string) => {
  switch (deptId) {
    case 'recepcao':
      return { color: 'text-[#0A84FF]', bg: 'bg-[#0A84FF]/15', iconName: 'Inbox' };
    case 'classificacao':
      return { color: 'text-[#FF9F0A]', bg: 'bg-[#FF9F0A]/15', iconName: 'Layers' };
    case 'formacao':
      return { color: 'text-[#30D158]', bg: 'bg-[#30D158]/15', iconName: 'UserCog' };
    default:
      return { color: 'text-[#5E5CE6]', bg: 'bg-[#5E5CE6]/15', iconName: 'LayoutGrid' };
  }
};
