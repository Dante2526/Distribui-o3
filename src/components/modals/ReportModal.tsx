    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className={
            isViewportBackdrop
              ? "flex items-center justify-center p-4 overflow-hidden z-[110]"
              : "fixed inset-0 z-[110] flex items-center justify-center p-4 overflow-hidden"
          }
          style={
            isViewportBackdrop
              ? {
                ...
                <div className="flex gap-3">
                  ...
                  <div className="flex-1 bg-blue-900/20 p-3 rounded-xl border border-blue-800 text-center relative overflow-hidden group flex flex-col items-center justify-center transition-all duration-300 hover:-translate-y-1 hover:scale-[1.03] hover:shadow-xl hover:shadow-blue-500/20 active:scale-[0.96] active:shadow-xl active:shadow-blue-500/40 active:bg-blue-800/30 transform cursor-pointer lg:cursor-default">
                    ...
                    <div className="relative z-10 flex flex-col items-center justify-center">
                      <span className="text-[9px] uppercase text-gray-400 block font-bold mb-1">
                        Total
                      </span>
              ...
              {stats && (
                <div className="grid grid-cols-4 gap-1 w-fit mx-auto mt-[-5px]">
                  <div className="bg-[#FF9F0A]/10 border border-[#FF9F0A]/20 rounded-lg py-1 px-1 w-[64px] flex flex-col items-center justify-center shadow-sm">
                    <span className="text-[16px] font-black tracking-tight mb-0 text-[#FF9F0A]">
                      {stats.ferias || 0}
                    </span>
                    <span className="text-[8px] uppercase font-bold tracking-wider text-[#FF9F0A]/80">
                      Férias
                    </span>
                  </div>
                  <div className="bg-[#FF453A]/10 border border-[#FF453A]/20 rounded-lg py-1 px-1 w-[64px] flex flex-col items-center justify-center shadow-sm">
                    <span className="text-[16px] font-black tracking-tight mb-0 text-[#FF453A]">
                      {stats.fora || 0}
                    </span>
                    <span className="text-[8px] uppercase font-bold tracking-wider text-[#FF453A]/80">
                      Fora
                    </span>
                  </div>
                  <div className="bg-[#FFD60A]/10 border border-[#FFD60A]/20 rounded-lg py-1 px-1 w-[64px] flex flex-col items-center justify-center shadow-sm">
                    <span className="text-[16px] font-black tracking-tight mb-0 text-[#FFD60A]">
                      {stats.atm || 0}
                    </span>
                    <span className="text-[8px] uppercase font-bold tracking-wider text-[#FFD60A]/80">
                      ATM
                    </span>
                  </div>
                  <div className="bg-[#BF5AF2]/10 border border-[#BF5AF2]/20 rounded-lg py-1 px-1 w-[64px] flex flex-col items-center justify-center shadow-sm">
                    <span className="text-[16px] font-black tracking-tight mb-0 text-[#BF5AF2]">
                      {stats.restricao || 0}
                    </span>
                    <span className="text-[8px] uppercase font-bold tracking-wider text-[#BF5AF2]/80">
                      Restrição
                    </span>
                  </div>
                  <div className="bg-[#30D158]/10 border border-[#30D158]/20 rounded-lg py-1 px-1 w-[64px] flex flex-col items-center justify-center shadow-sm">
                    <span className="text-[16px] font-black tracking-tight mb-0 text-[#30D158]">
                      {stats.estagio || 0}
                    </span>
                    <span className="text-[8px] uppercase font-bold tracking-wider text-[#30D158]/80">
                      Estágio
                    </span>
                  </div>
                  <div className="bg-[#FF453A]/10 border border-[#FF453A]/20 rounded-lg py-1 px-1 w-[64px] flex flex-col items-center justify-center shadow-sm">
                  ...
                  <div className="bg-[#0A84FF]/10 border border-[#0A84FF]/20 rounded-lg py-1 px-1 w-[64px] flex flex-col items-center justify-center shadow-sm">
                    <span className="text-[16px] font-black tracking-tight mb-0 text-[#0A84FF]">
                      {stats.treinamento || 0}
                    </span>
                    <span className="text-[8px] uppercase font-bold tracking-wider text-[#0A84FF]/80">
                      Treinam.
                    </span>
                  </div>
                  <div className="bg-[#32ADE6]/10 border border-[#32ADE6]/20 rounded-lg py-1 px-1 w-[64px] flex flex-col items-center justify-center shadow-sm">
                    <span className="text-[16px] font-black tracking-tight mb-0 text-[#32ADE6]">
                      {stats.revezamento || 0}
                    </span>
                    <span className="text-[8px] uppercase font-bold tracking-wider text-[#32ADE6]/80">
                      Revezam.
                    </span>
                  </div>
                </div>
