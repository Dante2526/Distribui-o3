...
export const ConfirmBiometricModal: React.FC<{
  ...
  onActivate: () => void;
  scale: number;
}> = React.memo(({ isOpen, onClose, onActivate, scale }) => {
    ...
    >
      <div className="space-y-4 text-center py-2">
        ...
        <p className="text-xs text-gray-600 dark:text-gray-300 px-2">
          Nos próximos acessos, você poderá entrar no painel de administração
          tocando na sua digital, de forma rápida e segura, sem precisar digitar
