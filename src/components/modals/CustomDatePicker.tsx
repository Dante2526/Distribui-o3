      ...
      <div className="w-full p-2 md:p-3 bg-white dark:bg-[#1A1C23] border border-gray-100 dark:border-gray-700/50 rounded-2xl">
        ...
        <div className="flex justify-between items-center mb-2 pb-1 border-b border-gray-100 dark:border-gray-800">
          <div className="font-extrabold text-sm md:text-base text-gray-800 dark:text-gray-100 capitalize flex flex-col leading-tight">
            ...
            <span className="text-[9px] md:text-[10px] text-indigo-500 font-black tracking-widest">
        ...
        <div className="grid grid-cols-7 gap-0.5 mb-1">
          {DAYS_OF_WEEK.map((day) => (
            <div
              key={day}
              className="text-center text-[9px] font-black tracking-wider text-gray-400 uppercase py-1"
            >
              {day}
            </div>
          ))}
        ...
        <div className="grid grid-cols-7 gap-0.5">
          {calendarDays.map((d, idx) => {
            let baseStyle =
              "h-7 md:h-8 w-full rounded-md md:rounded-lg flex items-center justify-center text-[11px] md:text-xs font-bold transition-all duration-150 outline-none ";
            ...
            if (d.isDisabled) {
              ...
              baseStyle +=
                "text-gray-300 dark:text-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800/50 hover:text-gray-500 dark:hover:text-gray-400 cursor-pointer ";
            } else {
              baseStyle +=
                "text-gray-700 dark:text-gray-200 hover:bg-indigo-50 hover:text-indigo-600 dark:hover:bg-indigo-500/20 dark:hover:text-indigo-300 cursor-pointer ";
            }
