...
export const SubjectIcon: React.FC<{ className?: string }> = ({
  className,
}) => (
  <svg
    className={className}
...
export const AusenteIcon: React.FC<{ className?: string }> = ({
  className,
}) => (
  <svg
    className={className}
...
export const ExchangeIcon: React.FC<{ className?: string }> = ({
  className,
}) => (
  <svg
    className={className}
...
export const MousePointerIcon: React.FC<{ className?: string }> = ({
  className,
}) => (
  <svg
    className={className}
