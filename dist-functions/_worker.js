...
var getDefaultsFromPostinstall = /* @__PURE__ */ __name2(
  () => void 0,
  "getDefaultsFromPostinstall",
);
var stringToByteArray$1 = /* @__PURE__ */ __name2(function (str) {
  const out = [];
  let p2 = 0;
...
var byteArrayToString = /* @__PURE__ */ __name2(function (bytes) {
  const out = [];
  let pos = 0,
    c = 0;
...
var DecodeBase64StringError = class extends Error {
  ...
  static {
    __name2(this, "DecodeBase64StringError");
  }
  constructor() {
    super(...arguments);
...
var base64Encode = /* @__PURE__ */ __name2(function (str) {
  const utf8Bytes = stringToByteArray$1(str);
  return base64.encodeByteArray(utf8Bytes, true);
}, "base64Encode");
var base64urlEncodeWithoutPadding = /* @__PURE__ */ __name2(function (str) {
  return base64Encode(str).replace(/\./g, "");
}, "base64urlEncodeWithoutPadding");
var base64Decode = /* @__PURE__ */ __name2(function (str) {
  try {
...
var getDefaultsFromGlobal = /* @__PURE__ */ __name2(
  () => getGlobal().__FIREBASE_DEFAULTS__,
  "getDefaultsFromGlobal",
);
var getDefaultsFromEnvVariable = /* @__PURE__ */ __name2(() => {
...
var getDefaultsFromCookie = /* @__PURE__ */ __name2(() => {
...
var getDefaults = /* @__PURE__ */ __name2(() => {
  try {
    return (
      getDefaultsFromPostinstall() ||
      getDefaultsFromGlobal() ||
...
var getDefaultEmulatorHost = /* @__PURE__ */ __name2(
  (productName) => getDefaults()?.emulatorHosts?.[productName],
  "getDefaultEmulatorHost",
);
var getDefaultEmulatorHostnameAndPort = /* @__PURE__ */ __name2(
  (productName) => {
...
var getDefaultAppConfig = /* @__PURE__ */ __name2(
  () => getDefaults()?.config,
  "getDefaultAppConfig",
);
var getExperimentalSetting = /* @__PURE__ */ __name2(
...
__name2(createMockUserToken, "createMockUserToken");
function getUA() {
  if (
...
__name2(isMobileCordova, "isMobileCordova");
...
__name2(isCloudflareWorker, "isCloudflareWorker");
...
__name2(isBrowserExtension, "isBrowserExtension");
...
__name2(isReactNative, "isReactNative");
function isIE() {
  const ua = getUA();
...
__name2(isIndexedDBAvailable, "isIndexedDBAvailable");
...
__name2(validateIndexedDBOpenable, "validateIndexedDBOpenable");
var ERROR_NAME = "FirebaseError";
var FirebaseError = class _FirebaseError extends Error {
  static {
    __name(this, "_FirebaseError");
  }
  static {
    __name2(this, "FirebaseError");
  }
...
__name2(replaceTemplate, "replaceTemplate");
var PATTERN = /\{\$([^}]+)}/g;
...
__name2(querystringDecode, "querystringDecode");
...
__name2(extractQuerystring, "extractQuerystring");
function createSubscribe(executor, onNoObservers) {
  const proxy = new ObserverProxy(executor, onNoObservers);
  return proxy.subscribe.bind(proxy);
}
__name(createSubscribe, "createSubscribe");
__name2(createSubscribe, "createSubscribe");
var ObserverProxy = class {
  static {
    __name(this, "ObserverProxy");
  }
  static {
    __name2(this, "ObserverProxy");
  }
  /**
...
__name2(implementsAnyMethods, "implementsAnyMethods");
function noop() {}
__name(noop, "noop");
__name2(noop, "noop");
...
__name2(getModularInstance, "getModularInstance");
...
__name2(isCloudWorkstation, "isCloudWorkstation");
...
__name2(normalizeIdentifierForFactory, "normalizeIdentifierForFactory");
function isComponentEager(component) {
  return component.instantiationMode === "EAGER";
}
__name(isComponentEager, "isComponentEager");
__name2(isComponentEager, "isComponentEager");
var ComponentContainer = class {
  static {
    __name(this, "ComponentContainer");
  }
  static {
    __name2(this, "ComponentContainer");
  }
  constructor(name4) {
    this.name = name4;
...
var defaultLogHandler = /* @__PURE__ */ __name2(
  (instance, logType, ...args) => {
...
var instanceOfAny = /* @__PURE__ */ __name2(
...
__name2(getIdbProxyableTypes, "getIdbProxyableTypes");
...
__name2(getCursorAdvanceMethods, "getCursorAdvanceMethods");
...
function promisifyRequest(request) {
  const promise = new Promise((resolve, reject) => {
    const unlisten = /* @__PURE__ */ __name2(() => {
      request.removeEventListener("success", success);
      request.removeEventListener("error", error);
    }, "unlisten");
    const success = /* @__PURE__ */ __name2(() => {
      resolve(wrap(request.result));
      unlisten();
    }, "success");
    const error = /* @__PURE__ */ __name2(() => {
...
__name2(promisifyRequest, "promisifyRequest");
function cacheDonePromiseForTransaction(tx) {
  ...
  const done = new Promise((resolve, reject) => {
    ...
    const complete = /* @__PURE__ */ __name2(() => {
      resolve();
      unlisten();
    }, "complete");
    const error = /* @__PURE__ */ __name2(() => {
...
__name2(cacheDonePromiseForTransaction, "cacheDonePromiseForTransaction");
var idbProxyTraps = {
...
__name2(replaceTraps, "replaceTraps");
...
__name2(wrapFunction, "wrapFunction");
...
__name2(transformCachableValue, "transformCachableValue");
function wrap(value) {
...
function getMethod(target, prop) {
  ...
  const method = /* @__PURE__ */ __name2(async function (storeName, ...args) {
...
var PlatformLoggerServiceImpl = class {
  ...
  static {
    __name2(this, "PlatformLoggerServiceImpl");
  }
...
__name2(isVersionServiceProvider, "isVersionServiceProvider");
...
__name2(_addComponent, "_addComponent");
...
__name2(_registerComponent, "_registerComponent");
...
__name2(_getProvider, "_getProvider");
...
__name2(_isFirebaseServerApp, "_isFirebaseServerApp");
var ERRORS = {
  ["no-app"]:
    /* AppError.NO_APP */
...
__name2(registerVersion, "registerVersion");
...
function getDbPromise() {
  if (!dbPromise) {
    dbPromise = openDB(DB_NAME, DB_VERSION, {
      upgrade: /* @__PURE__ */ __name2((db, oldVersion) => {
        switch (oldVersion) {
          case 0:
            try {
...
__name2(getDbPromise, "getDbPromise");
...
__name2(readHeartbeatsFromIndexedDB, "readHeartbeatsFromIndexedDB");
...
__name2(writeHeartbeatsToIndexedDB, "writeHeartbeatsToIndexedDB");
function computeKey(app) {
  return `${app.name}!${app.options.appId}`;
}
__name(computeKey, "computeKey");
__name2(computeKey, "computeKey");
...
var HeartbeatServiceImpl = class {
  ...
  static {
    __name2(this, "HeartbeatServiceImpl");
  }
  constructor(container) {
    this.container = container;
...
__name2(extractHeartbeatsForHeader, "extractHeartbeatsForHeader");
var HeartbeatStorageImpl = class {
  static {
    __name(this, "HeartbeatStorageImpl");
  }
  static {
    __name2(this, "HeartbeatStorageImpl");
  }
  constructor(app) {
    this.app = app;
...
__name2(getEarliestHeartbeatIdx, "getEarliestHeartbeatIdx");
...
__name2(registerCoreComponents, "registerCoreComponents");
...
__name2(__PRIVATE_setSDKVersion, "__PRIVATE_setSDKVersion");
...
__name2(__PRIVATE_logDebug, "__PRIVATE_logDebug");
...
__name2(__PRIVATE_logError, "__PRIVATE_logError");
...
__name2(__PRIVATE_logWarn, "__PRIVATE_logWarn");
function __PRIVATE_argToString(e) {
  if ("string" == typeof e) return e;
  try {
    return /* @__PURE__ */ __name2(
      /* @__PURE__ */ __name(function __PRIVATE_formatJSON(e2) {
        return JSON.stringify(e2);
      }, "__PRIVATE_formatJSON"),
      "__PRIVATE_formatJSON",
    )(e);
  } catch (t) {
    return e;
...
__name2(__PRIVATE_argToString, "__PRIVATE_argToString");
function fail(e, t, r) {
...
__name2(__PRIVATE__fail, "__PRIVATE__fail");
...
__name2(__PRIVATE_hardAssert, "__PRIVATE_hardAssert");
function __PRIVATE_debugCast(e, t) {
  return e;
}
__name(__PRIVATE_debugCast, "__PRIVATE_debugCast");
__name2(__PRIVATE_debugCast, "__PRIVATE_debugCast");
var d = {
...
var __PRIVATE_OAuthToken = class {
  ...
  static {
    __name2(this, "__PRIVATE_OAuthToken");
  }
  constructor(e, t) {
    ((this.user = t),
      (this.type = "OAuth"),
...
var __PRIVATE_EmptyAuthCredentialsProvider = class {
  ...
  static {
    __name2(this, "__PRIVATE_EmptyAuthCredentialsProvider");
  }
  getToken() {
...
var __PRIVATE_EmulatorAuthCredentialsProvider = class {
  ...
  static {
    __name2(this, "__PRIVATE_EmulatorAuthCredentialsProvider");
  }
  constructor(e) {
    ((this.token = e) /**
...
var __PRIVATE_LiteAuthCredentialsProvider = class {
  ...
  static {
    __name2(this, "__PRIVATE_LiteAuthCredentialsProvider");
  }
  constructor(e) {
    ((this.auth = null),
      e.onInit((e2) => {
...
var __PRIVATE_FirstPartyToken = class {
  ...
  static {
    __name2(this, "__PRIVATE_FirstPartyToken");
  }
  constructor(e, t, r) {
    ((this.i = e),
      (this.o = t),
...
var __PRIVATE_FirstPartyAuthCredentialsProvider = class {
  ...
  static {
    __name2(this, "__PRIVATE_FirstPartyAuthCredentialsProvider");
  }
  constructor(e, t, r) {
...
var __PRIVATE_LiteAppCheckTokenProvider = class {
  ...
  static {
    __name2(this, "__PRIVATE_LiteAppCheckTokenProvider");
  }
  constructor(e, t) {
    ((this.m = t),
      (this.appCheck = null),
...
var DatabaseId = class _DatabaseId {
  static {
    __name(this, "_DatabaseId");
  }
  static {
    __name2(this, "DatabaseId");
  }
  constructor(e, t) {
...
__name2(__PRIVATE_databaseIdFromApp, "__PRIVATE_databaseIdFromApp");
...
__name2(__PRIVATE_randomBytes, "__PRIVATE_randomBytes");
var __PRIVATE_AutoId = class {
  static {
    __name(this, "__PRIVATE_AutoId");
  }
  static {
    __name2(this, "__PRIVATE_AutoId");
  }
  static newId() {
...
__name2(__PRIVATE_primitiveComparator, "__PRIVATE_primitiveComparator");
...
__name2(__PRIVATE_compareUtf8Strings, "__PRIVATE_compareUtf8Strings");
var T = 55296;
var P = 57343;
...
__name2(__PRIVATE_isSurrogate, "__PRIVATE_isSurrogate");
...
__name2(__PRIVATE_arrayEquals, "__PRIVATE_arrayEquals");
var V = "__name__";
var BasePath = class _BasePath {
  static {
    __name(this, "_BasePath");
  }
  static {
    __name2(this, "BasePath");
  }
  constructor(e, t, r) {
    (void 0 === t
      ? (t = 0)
...
var ResourcePath = class _ResourcePath extends BasePath {
  static {
    __name(this, "_ResourcePath");
  }
  static {
    __name2(this, "ResourcePath");
  }
  construct(e, t, r) {
...
var FieldPath$1 = class _FieldPath$1 extends BasePath {
  static {
    __name(this, "_FieldPath$1");
  }
  static {
    __name2(this, "FieldPath$1");
  }
  construct(e, t, r) {
  ...
  static fromServerFormat(e) {
    ...
    let r = "",
      n = 0;
    const __PRIVATE_addCurrentSegment = /* @__PURE__ */ __name2(() => {
      if (0 === r.length)
        throw new FirestoreError(
          d.INVALID_ARGUMENT,
...
var DocumentKey = class _DocumentKey {
  static {
    __name(this, "_DocumentKey");
  }
  static {
    __name2(this, "DocumentKey");
  }
  constructor(e) {
    this.path = e;
  }
...
__name2(__PRIVATE_validateDocumentPath, "__PRIVATE_validateDocumentPath");
...
__name2(__PRIVATE_isPlainObject, "__PRIVATE_isPlainObject");
...
__name2(__PRIVATE_valueDescription, "__PRIVATE_valueDescription");
...
__name2(__PRIVATE_cast, "__PRIVATE_cast");
...
__name2(__PRIVATE_cloneLongPollingOptions, "__PRIVATE_cloneLongPollingOptions");
var A = null;
...
__name2(__PRIVATE_generateUniqueDebugId, "__PRIVATE_generateUniqueDebugId");
function __PRIVATE_isNegativeZero(e) {
  return 0 === e && 1 / e == -1 / 0;
}
__name(__PRIVATE_isNegativeZero, "__PRIVATE_isNegativeZero");
__name2(__PRIVATE_isNegativeZero, "__PRIVATE_isNegativeZero");
...
var __PRIVATE_RestConnection = class {
  ...
  static {
    __name2(this, "__PRIVATE_RestConnection");
  }
  get P() {
    return false;
  }
...
__name2(__PRIVATE_mapCodeFromHttpStatus, "__PRIVATE_mapCodeFromHttpStatus");
(((w = y || (y = {}))[(w.OK = 0)] = "OK"),
...
var __PRIVATE_FetchConnection = class extends __PRIVATE_RestConnection {
  ...
  static {
    __name2(this, "__PRIVATE_FetchConnection");
  }
  N(e, t) {
...
__name2(__PRIVATE_objectSize, "__PRIVATE_objectSize");
...
var __PRIVATE_Base64DecodeError = class extends Error {
  ...
  static {
    __name2(this, "__PRIVATE_Base64DecodeError");
  }
  constructor() {
...
var ByteString = class _ByteString {
  static {
    __name(this, "_ByteString");
  }
  static {
    __name2(this, "ByteString");
  }
  constructor(e) {
    this.binaryString = e;
  }
  static fromBase64String(e) {
    const t = /* @__PURE__ */ __name2(
      /* @__PURE__ */ __name(function __PRIVATE_decodeBase64(e2) {
        try {
          return atob(e2);
        } catch (e3) {
  ...
  static fromUint8Array(e) {
    const t =
       ...
       */
      /* @__PURE__ */ __name2(
        /* @__PURE__ */ __name(function __PRIVATE_binaryStringFromUint8Array(
          e2,
        ) {
          let t2 = "";
  ...
  toBase64() {
    return /* @__PURE__ */ __name2(
      /* @__PURE__ */ __name(function __PRIVATE_encodeBase64(e) {
        return btoa(e);
      }, "__PRIVATE_encodeBase64"),
      "__PRIVATE_encodeBase64",
    )(this.binaryString);
  }
  toUint8Array() {
    return /* @__PURE__ */ __name2(
      /* @__PURE__ */ __name(function __PRIVATE_uint8ArrayFromBinaryString(e) {
...
__name2(__PRIVATE_normalizeTimestamp, "__PRIVATE_normalizeTimestamp");
function __PRIVATE_normalizeNumber(e) {
  return "number" == typeof e ? e : "string" == typeof e ? Number(e) : 0;
}
__name(__PRIVATE_normalizeNumber, "__PRIVATE_normalizeNumber");
__name2(__PRIVATE_normalizeNumber, "__PRIVATE_normalizeNumber");
...
__name2(__PRIVATE_normalizeByteString, "__PRIVATE_normalizeByteString");
...
__name2(__PRIVATE_validateJSON, "__PRIVATE_validateJSON");
var F = -62135596800;
var v = 1e6;
...
__name2(__PRIVATE_isServerTimestamp, "__PRIVATE_isServerTimestamp");
function __PRIVATE_getPreviousValue(e) {
  const t = e.mapValue.fields.__previous_value__;
  return __PRIVATE_isServerTimestamp(t) ? __PRIVATE_getPreviousValue(t) : t;
}
__name(__PRIVATE_getPreviousValue, "__PRIVATE_getPreviousValue");
__name2(__PRIVATE_getPreviousValue, "__PRIVATE_getPreviousValue");
...
__name2(__PRIVATE_getLocalWriteTime, "__PRIVATE_getLocalWriteTime");
var b = "__type__";
var D = "__max__";
var S = "__vector__";
var C = "value";
...
__name2(__PRIVATE_typeOrder, "__PRIVATE_typeOrder");
function __PRIVATE_valueEquals(e, t, r) {
  ...
  switch (n) {
    ...
    case 3:
      return /* @__PURE__ */ __name2(
        /* @__PURE__ */ __name(function __PRIVATE_timestampEquals(e2, t2) {
          if (
    ...
    case 6:
      return /* @__PURE__ */ __name2(
        /* @__PURE__ */ __name(function __PRIVATE_blobEquals(e2, t2) {
    ...
    case 8:
      return /* @__PURE__ */ __name2(
        /* @__PURE__ */ __name(function __PRIVATE_geoPointEquals(e2, t2) {
          return (
    ...
    case 2:
      return /* @__PURE__ */ __name2(
        /* @__PURE__ */ __name(function __PRIVATE_numberEquals(e2, t2, r2) {
          ...
          if ("doubleValue" in e2 && "doubleValue" in t2)
            ...
            ((n2 = __PRIVATE_normalizeNumber(
              e2.integerValue ?? e2.doubleValue,
            )),
              (i = __PRIVATE_normalizeNumber(
                t2.integerValue ?? t2.doubleValue,
              )));
          }
          if (n2 === i)
            return (
    ...
    case 11:
      return /* @__PURE__ */ __name2(
        /* @__PURE__ */ __name(function __PRIVATE_objectEquals(e2, t2, r2) {
          const n2 = e2.mapValue.fields || {},
            i = t2.mapValue.fields || {};
          if (__PRIVATE_objectSize(n2) !== __PRIVATE_objectSize(i))
            return false;
          for (const e3 in n2)
            if (
...
__name2(__PRIVATE_valueEquals, "__PRIVATE_valueEquals");
function __PRIVATE_isMapValue(e) {
  return !!e && "mapValue" in e;
}
__name(__PRIVATE_isMapValue, "__PRIVATE_isMapValue");
__name2(__PRIVATE_isMapValue, "__PRIVATE_isMapValue");
...
__name2(__PRIVATE_deepClone, "__PRIVATE_deepClone");
var SnapshotVersion = class _SnapshotVersion {
  static {
    __name(this, "_SnapshotVersion");
  }
  static {
    __name2(this, "SnapshotVersion");
  }
...
var SortedMap = class _SortedMap {
  static {
    __name(this, "_SortedMap");
  }
  static {
    __name2(this, "SortedMap");
  }
  constructor(e, t) {
...
var SortedMapIterator = class {
  ...
  static {
    __name2(this, "SortedMapIterator");
  }
  constructor(e, t, r, n) {
...
var LLRBNode = class _LLRBNode {
  static {
    __name(this, "_LLRBNode");
  }
  static {
    __name2(this, "LLRBNode");
  }
...
var SortedSet = class _SortedSet {
  static {
    __name(this, "_SortedSet");
  }
  static {
    __name2(this, "SortedSet");
  }
  constructor(e) {
...
var SortedSetIterator = class {
  ...
  static {
    __name2(this, "SortedSetIterator");
  }
  constructor(e) {
    this.iter = e;
  }
...
var FieldMask = class _FieldMask {
  static {
    __name(this, "_FieldMask");
  }
  static {
    __name2(this, "FieldMask");
  }
  constructor(e) {
...
var ObjectValue = class _ObjectValue {
  static {
    __name(this, "_ObjectValue");
  }
  static {
    __name2(this, "ObjectValue");
  }
  constructor(e) {
    this.value = e;
  }
...
var MutableDocument = class _MutableDocument {
  static {
    __name(this, "_MutableDocument");
  }
  static {
    __name2(this, "MutableDocument");
  }
...
var __PRIVATE_QueryImpl = class {
  ...
  static {
    __name2(this, "__PRIVATE_QueryImpl");
  }
  /**
...
__name2(__PRIVATE_toDouble, "__PRIVATE_toDouble");
...
__name2(__PRIVATE_toInteger, "__PRIVATE_toInteger");
...
var TransformOperation = class {
  ...
  static {
    __name2(this, "TransformOperation");
  }
  constructor() {
    this._ = void 0;
  }
...
var __PRIVATE_ServerTimestampTransform = class extends TransformOperation {
  ...
  static {
    __name2(this, "__PRIVATE_ServerTimestampTransform");
  }
};
var __PRIVATE_ArrayUnionTransformOperation = class extends TransformOperation {
  ...
  static {
    __name2(this, "__PRIVATE_ArrayUnionTransformOperation");
  }
  constructor(e) {
...
var __PRIVATE_ArrayRemoveTransformOperation = class extends TransformOperation {
  ...
  static {
    __name2(this, "__PRIVATE_ArrayRemoveTransformOperation");
  }
  constructor(e) {
    (super(), (this.elements = e));
  }
...
var __PRIVATE_NumericTransformOperation = class extends TransformOperation {
  ...
  static {
    __name2(this, "__PRIVATE_NumericTransformOperation");
  }
  constructor(e, t) {
...
var __PRIVATE_NumericIncrementTransformOperation = class extends __PRIVATE_NumericTransformOperation {
  ...
  static {
    __name2(this, "__PRIVATE_NumericIncrementTransformOperation");
  }
};
var __PRIVATE_NumericMinimumTransformOperation = class extends __PRIVATE_NumericTransformOperation {
  ...
  static {
    __name2(this, "__PRIVATE_NumericMinimumTransformOperation");
  }
};
var __PRIVATE_NumericMaximumTransformOperation = class extends __PRIVATE_NumericTransformOperation {
  ...
  static {
    __name2(this, "__PRIVATE_NumericMaximumTransformOperation");
  }
};
var Precondition = class _Precondition {
  static {
    __name(this, "_Precondition");
  }
  static {
    __name2(this, "Precondition");
  }
  constructor(e, t) {
...
var __PRIVATE_SetMutation = class extends Mutation {
  ...
  static {
    __name2(this, "__PRIVATE_SetMutation");
  }
  constructor(e, t, r, n = []) {
    (super(),
      (this.key = e),
...
var __PRIVATE_PatchMutation = class extends Mutation {
  ...
  static {
    __name2(this, "__PRIVATE_PatchMutation");
  }
  constructor(e, t, r, n, i = []) {
    (super(),
      (this.key = e),
...
var __PRIVATE_DeleteMutation = class extends Mutation {
  ...
  static {
    __name2(this, "__PRIVATE_DeleteMutation");
  }
  constructor(e, t) {
    (super(),
      (this.key = e),
...
var __PRIVATE_VerifyMutation = class extends Mutation {
  ...
  static {
    __name2(this, "__PRIVATE_VerifyMutation");
  }
  constructor(e, t) {
    (super(),
      (this.key = e),
...
var JsonProtoSerializer = class {
  ...
  static {
    __name2(this, "JsonProtoSerializer");
  }
  constructor(e, t) {
...
__name2(__PRIVATE_toBytes, "__PRIVATE_toBytes");
function __PRIVATE_toVersion(e, t) {
  return toTimestamp(e, t.toTimestamp());
}
__name(__PRIVATE_toVersion, "__PRIVATE_toVersion");
__name2(__PRIVATE_toVersion, "__PRIVATE_toVersion");
...
function __PRIVATE_toResourcePath(e, t) {
  const r = /* @__PURE__ */ __name2(
    ...
    }, "__PRIVATE_fullyQualifiedPrefixPath"),
    "__PRIVATE_fullyQualifiedPrefixPath",
  )(e).child("documents");
  return void 0 === t ? r : r.child(t);
}
__name(__PRIVATE_toResourcePath, "__PRIVATE_toResourcePath");
__name2(__PRIVATE_toResourcePath, "__PRIVATE_toResourcePath");
function __PRIVATE_toName(e, t) {
  return __PRIVATE_toResourceName(e.databaseId, t.path);
}
__name(__PRIVATE_toName, "__PRIVATE_toName");
__name2(__PRIVATE_toName, "__PRIVATE_toName");
function fromName(e, t) {
  const r = /* @__PURE__ */ __name2(
    /* @__PURE__ */ __name(function __PRIVATE_fromResourceName(e2) {
...
__name2(__PRIVATE_toMutationDocument, "__PRIVATE_toMutationDocument");
    ...
    t.fieldTransforms.length > 0 &&
      (r.updateTransforms = t.fieldTransforms.map((e2) =>
        /* @__PURE__ */ __name2(
          ...
          }, "__PRIVATE_toFieldTransform"),
          "__PRIVATE_toFieldTransform",
        )(0, e2),
      )),
    t.precondition.isNone ||
      (r.currentDocument = /* @__PURE__ */ __name2(
        /* @__PURE__ */ __name(function __PRIVATE_toPrecondition(e2, t2) {
...
__name2(__PRIVATE_toDocumentMask, "__PRIVATE_toDocumentMask");
function __PRIVATE_isValidResourceName(e) {
  return e.length >= 4 && "projects" === e.get(0) && "databases" === e.get(2);
}
__name(__PRIVATE_isValidResourceName, "__PRIVATE_isValidResourceName");
__name2(__PRIVATE_isValidResourceName, "__PRIVATE_isValidResourceName");
...
__name2(__PRIVATE_newSerializer, "__PRIVATE_newSerializer");
var Datastore = class {
  static {
    __name(this, "Datastore");
  }
  static {
    __name2(this, "Datastore");
  }
};
var __PRIVATE_DatastoreImpl = class extends Datastore {
  ...
  static {
    __name2(this, "__PRIVATE_DatastoreImpl");
  }
  constructor(e, t, r, n) {
    (super(),
...
__name2(__PRIVATE_invokeCommitRpc, "__PRIVATE_invokeCommitRpc");
...
function __PRIVATE_getDatastore(e) {
  ...
  if (!B.has(e)) {
    ...
    const t = /* @__PURE__ */ __name2(
        /* @__PURE__ */ __name(function __PRIVATE_newConnection(e2) {
          ...
          /* @__PURE__ */ __name(function __PRIVATE_makeDatabaseInfo(
            ...
            return new DatabaseInfo(
              ...
              __PRIVATE_cloneLongPollingOptions(
                i.experimentalLongPollingOptions,
              ),
              i.useFetchStreams,
              i.isUsingEmulator,
              n2,
      ...
      n = /* @__PURE__ */ __name2(
        /* @__PURE__ */ __name(function __PRIVATE_newDatastore(e2, t2, r2, n2) {
...
__name2(__PRIVATE_getDatastore, "__PRIVATE_getDatastore");
var x = 1048576;
...
var FirestoreSettingsImpl = class {
  ...
  static {
    __name2(this, "FirestoreSettingsImpl");
  }
  constructor(e) {
    if (void 0 === e.host) {
      if (void 0 !== e.ssl)
    ...
    (!/* @__PURE__ */ __name2(
      ...
      /* @__PURE__ */ __name2(
        /* @__PURE__ */ __name(function __PRIVATE_validateLongPollingOptions(
          e2,
        ) {
  ...
  isEqual(e) {
    return (
      ...
      this.experimentalAutoDetectLongPolling ===
        e.experimentalAutoDetectLongPolling &&
      /* @__PURE__ */ __name2(
        /* @__PURE__ */ __name(function __PRIVATE_longPollingOptionsEqual(
          e2,
          t,
        ) {
  ...
  _setSettings(e) {
    ...
    ((this._settings = new FirestoreSettingsImpl(e)),
      ...
      void 0 !== e.credentials &&
        (this._authCredentials = /* @__PURE__ */ __name2(
          /* @__PURE__ */ __name(function __PRIVATE_makeAuthCredentialsProvider(
            e2,
          ) {
...
__name2(getFirestore, "getFirestore");
...
__name2(connectFirestoreEmulator, "connectFirestoreEmulator");
...
var DocumentReference = class _DocumentReference {
  static {
    __name(this, "_DocumentReference");
  }
  static {
    __name2(this, "DocumentReference");
  }
  /** @hideconstructor */
  constructor(e, t, r) {
    ((this.converter = t),
...
var CollectionReference = class _CollectionReference extends Query {
  static {
    __name(this, "_CollectionReference");
  }
  static {
    __name2(this, "CollectionReference");
  }
  /** @hideconstructor */
  constructor(e, t, r) {
    (super(
...
var GeoPoint = class _GeoPoint {
  static {
    __name(this, "_GeoPoint");
  }
  static {
    __name2(this, "GeoPoint");
  }
  /**
...
var VectorValue = class _VectorValue {
  static {
    __name(this, "_VectorValue");
  }
  static {
    __name2(this, "VectorValue");
  }
  /**
   * @private
   * @internal
  ...
  isEqual(e) {
    return /* @__PURE__ */ __name2(
      /* @__PURE__ */ __name(function __PRIVATE_isPrimitiveArrayEqual(e2, t) {
        if (e2.length !== t.length) return false;
        for (let r = 0; r < e2.length; ++r) if (e2[r] !== t[r]) return false;
        return true;
      }, "__PRIVATE_isPrimitiveArrayEqual"),
      "__PRIVATE_isPrimitiveArrayEqual",
...
__name2(__PRIVATE_isWrite, "__PRIVATE_isWrite");
var ParseContextImpl = class _ParseContextImpl {
  static {
    __name(this, "_ParseContextImpl");
  }
  static {
    __name2(this, "ParseContextImpl");
  }
  /**
...
__name2(__PRIVATE_newUserDataReader, "__PRIVATE_newUserDataReader");
var __PRIVATE_DeleteFieldValueImpl = class ___PRIVATE_DeleteFieldValueImpl extends FieldValue {
  static {
    __name(this, "___PRIVATE_DeleteFieldValueImpl");
  }
  static {
    __name2(this, "__PRIVATE_DeleteFieldValueImpl");
  }
  _toFieldTransform(e) {
    if (2 !== e.dataSource)
...
__name2(__PRIVATE_parseUpdateData, "__PRIVATE_parseUpdateData");
...
__name2(__PRIVATE_parseUpdateVarargs, "__PRIVATE_parseUpdateVarargs");
function __PRIVATE_parseData(e, t, r) {
  ...
  if (
    ...
    return /* @__PURE__ */ __name2(
      /* @__PURE__ */ __name(function __PRIVATE_parseArray(e2, t2) {
        const r2 = [];
        let n = 0;
        for (const i of e2) {
      ...
      }, "__PRIVATE_parseArray"),
      "__PRIVATE_parseArray",
    )(e, t);
  }
  return /* @__PURE__ */ __name2(
    /* @__PURE__ */ __name(function __PRIVATE_parseScalarValue(e2, t2, r2) {
      ...
      if (e2 instanceof VectorValue)
        return /* @__PURE__ */ __name2(
          /* @__PURE__ */ __name(function __PRIVATE_parseVectorValue(e3, t3) {
    ...
    }, "__PRIVATE_parseScalarValue"),
    "__PRIVATE_parseScalarValue",
  )(e, t, r);
}
__name(__PRIVATE_parseData, "__PRIVATE_parseData");
__name2(__PRIVATE_parseData, "__PRIVATE_parseData");
...
__name2(__PRIVATE_parseObject, "__PRIVATE_parseObject");
...
__name2(__PRIVATE_looksLikeJsonObject, "__PRIVATE_looksLikeJsonObject");
...
__name2(__PRIVATE_validatePlainObject, "__PRIVATE_validatePlainObject");
...
__name2(__PRIVATE_fieldPathFromArgument, "__PRIVATE_fieldPathFromArgument");
var k = new RegExp("[~\\*/\\[\\]]");
...
__name2(__PRIVATE_fieldMaskContains, "__PRIVATE_fieldMaskContains");
var DocumentSnapshot = class {
  static {
    __name(this, "DocumentSnapshot");
  }
  static {
    __name2(this, "DocumentSnapshot");
  }
...
var QueryDocumentSnapshot = class extends DocumentSnapshot {
  ...
  static {
    __name2(this, "QueryDocumentSnapshot");
  }
  /**
...
var AbstractUserDataWriter = class {
  ...
  static {
    __name2(this, "AbstractUserDataWriter");
  }
...
var __PRIVATE_LiteUserDataWriter = class extends AbstractUserDataWriter {
  ...
  static {
    __name2(this, "__PRIVATE_LiteUserDataWriter");
  }
  constructor(e) {
...
__name2(_prodErrorMap, "_prodErrorMap");
...
__name2(_createError, "_createError");
...
__name2(_errorWithCustomMessage, "_errorWithCustomMessage");
...
__name2(createErrorInternal, "createErrorInternal");
...
__name2(_getUserLanguage, "_getUserLanguage");
var Delay = class {
  static {
    __name(this, "Delay");
  }
...
__name2(_emulatorUrl, "_emulatorUrl");
var FetchProvider = class {
  static {
    __name(this, "FetchProvider");
  }
  static {
    __name2(this, "FetchProvider");
  }
...
__name2(_addTidIfNecessary, "_addTidIfNecessary");
...
__name2(_performApiRequest, "_performApiRequest");
...
__name2(_performFetchWithErrorHandling, "_performFetchWithErrorHandling");
...
__name2(_performSignInRequest, "_performSignInRequest");
...
__name2(_getFinalTarget, "_getFinalTarget");
...
__name2(_parseEnforcementState, "_parseEnforcementState");
var NetworkTimeout = class {
  static {
    __name(this, "NetworkTimeout");
  }
  static {
    __name2(this, "NetworkTimeout");
  }
  clearNetworkTimeout() {
...
__name2(_makeTaggedError, "_makeTaggedError");
function isEnterprise(grecaptcha) {
  return grecaptcha !== void 0 && grecaptcha.enterprise !== void 0;
}
__name(isEnterprise, "isEnterprise");
__name2(isEnterprise, "isEnterprise");
var RecaptchaConfig = class {
  static {
    __name(this, "RecaptchaConfig");
  }
  static {
    __name2(this, "RecaptchaConfig");
  }
...
__name2(getRecaptchaConfig, "getRecaptchaConfig");
async function deleteAccount(auth, request) {
  return _performApiRequest(auth, "POST", "/v1/accounts:delete", request);
}
__name(deleteAccount, "deleteAccount");
__name2(deleteAccount, "deleteAccount");
async function getAccountInfo(auth, request) {
  return _performApiRequest(auth, "POST", "/v1/accounts:lookup", request);
}
__name(getAccountInfo, "getAccountInfo");
__name2(getAccountInfo, "getAccountInfo");
...
__name2(utcTimestampToDateString, "utcTimestampToDateString");
...
__name2(getIdTokenResult, "getIdTokenResult");
function secondsStringToMilliseconds(seconds) {
  return Number(seconds) * 1e3;
}
__name(secondsStringToMilliseconds, "secondsStringToMilliseconds");
__name2(secondsStringToMilliseconds, "secondsStringToMilliseconds");
...
__name2(_parseToken, "_parseToken");
...
__name2(_tokenExpiresIn, "_tokenExpiresIn");
...
__name2(_logoutIfInvalidated, "_logoutIfInvalidated");
...
__name2(isUserInvalidated, "isUserInvalidated");
var ProactiveRefresh = class {
  static {
    __name(this, "ProactiveRefresh");
  }
  static {
    __name2(this, "ProactiveRefresh");
  }
  constructor(user) {
    this.user = user;
...
__name2(_reloadWithoutSaving, "_reloadWithoutSaving");
...
__name2(mergeProviderData, "mergeProviderData");
...
__name2(extractProviderData, "extractProviderData");
...
__name2(requestStsToken, "requestStsToken");
...
__name2(revokeToken, "revokeToken");
var StsTokenManager = class _StsTokenManager {
  static {
    __name(this, "_StsTokenManager");
  }
  static {
    __name2(this, "StsTokenManager");
  }
  constructor() {
...
__name2(assertStringOrUndefined, "assertStringOrUndefined");
var UserImpl = class _UserImpl {
  static {
    __name(this, "_UserImpl");
  }
  static {
    __name2(this, "UserImpl");
  }
...
__name2(_getInstance, "_getInstance");
var InMemoryPersistence = class {
  static {
    __name(this, "InMemoryPersistence");
  }
  static {
    __name2(this, "InMemoryPersistence");
  }
  constructor() {
    this.type = "NONE";
    this.storage = {};
...
__name2(_persistenceKeyName, "_persistenceKeyName");
var PersistenceUserManager = class _PersistenceUserManager {
  static {
    __name(this, "_PersistenceUserManager");
  }
  static {
    __name2(this, "PersistenceUserManager");
  }
...
__name2(_getBrowserName, "_getBrowserName");
function _isFirefox(ua = getUA()) {
  return /firefox\//i.test(ua);
}
__name(_isFirefox, "_isFirefox");
__name2(_isFirefox, "_isFirefox");
...
__name2(_isMobileBrowser, "_isMobileBrowser");
...
__name2(_getClientVersion, "_getClientVersion");
var AuthMiddlewareQueue = class {
  static {
    __name(this, "AuthMiddlewareQueue");
  }
  static {
    __name2(this, "AuthMiddlewareQueue");
  }
  constructor(auth) {
    this.auth = auth;
    this.queue = [];
  ...
  pushCallback(callback, onAbort) {
    const wrappedCallback = /* @__PURE__ */ __name2(
      (user) =>
...
__name2(_getPasswordPolicy, "_getPasswordPolicy");
...
var PasswordPolicyImpl = class {
  ...
  static {
    __name2(this, "PasswordPolicyImpl");
  }
  constructor(response) {
...
__name2(_castAuth, "_castAuth");
var Subscription = class {
  static {
    __name(this, "Subscription");
  }
  static {
    __name2(this, "Subscription");
  }
  constructor(auth) {
    this.auth = auth;
    this.observer = null;
...
var RecaptchaEnterpriseVerifier = class _RecaptchaEnterpriseVerifier {
  static {
    __name(this, "_RecaptchaEnterpriseVerifier");
  }
  static {
    __name2(this, "RecaptchaEnterpriseVerifier");
  }
  /**
   *
  ...
  async verify(action = "verify", forceRefresh = false) {
    ...
    __name2(retrieveSiteKey, "retrieveSiteKey");
    ...
    __name2(retrieveRecaptchaToken, "retrieveRecaptchaToken");
...
__name2(injectRecaptchaFields, "injectRecaptchaFields");
...
__name2(handleRecaptchaFlow, "handleRecaptchaFlow");
...
__name2(_initializeRecaptchaConfig, "_initializeRecaptchaConfig");
...
__name2(initializeAuth, "initializeAuth");
...
__name2(_initializeAuthInstance, "_initializeAuthInstance");
...
__name2(connectAuthEmulator, "connectAuthEmulator");
...
__name2(extractHostAndPort, "extractHostAndPort");
...
function emitEmulatorWarning() {
  ...
  __name2(attachBanner, "attachBanner");
...
__name2(emitEmulatorWarning, "emitEmulatorWarning");
var AuthCredential = class {
  static {
    __name(this, "AuthCredential");
  }
  static {
    __name2(this, "AuthCredential");
  }
  /** @internal */
...
__name2(linkEmailPassword, "linkEmailPassword");
...
__name2(signInWithEmailLink$1, "signInWithEmailLink$1");
...
__name2(signInWithEmailLinkForLinking, "signInWithEmailLinkForLinking");
var EmailAuthCredential = class _EmailAuthCredential extends AuthCredential {
  static {
    __name(this, "_EmailAuthCredential");
  }
  static {
    __name2(this, "EmailAuthCredential");
  }
  /** @internal */
...
__name2(signInWithIdp, "signInWithIdp");
var IDP_REQUEST_URI$1 = "http://localhost";
var OAuthCredential = class _OAuthCredential extends AuthCredential {
  static {
    __name(this, "_OAuthCredential");
  }
  static {
    __name2(this, "OAuthCredential");
  }
  constructor() {
    super(...arguments);
...
__name2(sendPhoneVerificationCode, "sendPhoneVerificationCode");
...
__name2(signInWithPhoneNumber$1, "signInWithPhoneNumber$1");
...
__name2(linkWithPhoneNumber$1, "linkWithPhoneNumber$1");
...
__name2(verifyPhoneNumberForExisting, "verifyPhoneNumberForExisting");
var PhoneAuthCredential = class _PhoneAuthCredential extends AuthCredential {
  static {
    __name(this, "_PhoneAuthCredential");
  }
  static {
    __name2(this, "PhoneAuthCredential");
  }
  constructor(params) {
    super(
      "phone",
...
__name2(parseDeepLink, "parseDeepLink");
var ActionCodeURL = class _ActionCodeURL {
  static {
    __name(this, "_ActionCodeURL");
  }
  static {
    __name2(this, "ActionCodeURL");
  }
  /**
...
var EmailAuthProvider = class _EmailAuthProvider {
  static {
    __name(this, "_EmailAuthProvider");
  }
  static {
    __name2(this, "EmailAuthProvider");
  }
  constructor() {
...
var FederatedAuthProvider = class {
  ...
  static {
    __name2(this, "FederatedAuthProvider");
  }
  /**
...
var BaseOAuthProvider = class extends FederatedAuthProvider {
  ...
  static {
    __name2(this, "BaseOAuthProvider");
  }
  constructor() {
    super(...arguments);
    this.scopes = [];
...
var FacebookAuthProvider = class _FacebookAuthProvider extends BaseOAuthProvider {
  static {
    __name(this, "_FacebookAuthProvider");
  }
  static {
    __name2(this, "FacebookAuthProvider");
  }
  constructor() {
    super(
      "facebook.com",
...
var GoogleAuthProvider = class _GoogleAuthProvider extends BaseOAuthProvider {
  static {
    __name(this, "_GoogleAuthProvider");
  }
  static {
    __name2(this, "GoogleAuthProvider");
  }
  constructor() {
    super(
      "google.com",
...
var GithubAuthProvider = class _GithubAuthProvider extends BaseOAuthProvider {
  static {
    __name(this, "_GithubAuthProvider");
  }
  static {
    __name2(this, "GithubAuthProvider");
  }
  constructor() {
    super(
      "github.com",
...
var TwitterAuthProvider = class _TwitterAuthProvider extends BaseOAuthProvider {
  static {
    __name(this, "_TwitterAuthProvider");
  }
  static {
    __name2(this, "TwitterAuthProvider");
  }
  constructor() {
    super(
      "twitter.com",
...
__name2(signUp, "signUp");
var UserCredentialImpl = class _UserCredentialImpl {
  static {
    __name(this, "_UserCredentialImpl");
  }
  static {
    __name2(this, "UserCredentialImpl");
  }
  constructor(params) {
...
__name2(providerIdForResponse, "providerIdForResponse");
...
__name2(signInAnonymously, "signInAnonymously");
var MultiFactorError = class _MultiFactorError extends FirebaseError {
  static {
    __name(this, "_MultiFactorError");
  }
  static {
    __name2(this, "MultiFactorError");
  }
...
__name2(_reauthenticate, "_reauthenticate");
...
__name2(_signInWithCredential, "_signInWithCredential");
...
__name2(onIdTokenChanged, "onIdTokenChanged");
function beforeAuthStateChanged(auth, callback, onAbort) {
  return getModularInstance(auth).beforeAuthStateChanged(callback, onAbort);
}
__name(beforeAuthStateChanged, "beforeAuthStateChanged");
__name2(beforeAuthStateChanged, "beforeAuthStateChanged");
...
__name2(startEnrollPhoneMfa, "startEnrollPhoneMfa");
...
__name2(finalizeEnrollPhoneMfa, "finalizeEnrollPhoneMfa");
...
__name2(startEnrollTotpMfa, "startEnrollTotpMfa");
...
__name2(finalizeEnrollTotpMfa, "finalizeEnrollTotpMfa");
...
var BrowserPersistenceClass = class {
  ...
  static {
    __name2(this, "BrowserPersistenceClass");
  }
...
var BrowserLocalPersistence = class extends BrowserPersistenceClass {
  ...
  static {
    __name2(this, "BrowserLocalPersistence");
  }
  constructor() {
    super(
      () => window.localStorage,
  ...
  onStorageEvent(event, poll = false) {
    ...
    const triggerListeners = /* @__PURE__ */ __name2(() => {
...
var CookiePersistence = class {
  ...
  _addListener(key, listener) {
    ...
    const name4 = getCookieName(key);
    if (window.cookieStore) {
      const cb = /* @__PURE__ */ __name2((event) => {
      ...
      const unsubscribe2 = /* @__PURE__ */ __name2(
...
var BrowserSessionPersistence = class extends BrowserPersistenceClass {
  ...
  static {
    __name2(this, "BrowserSessionPersistence");
  }
  constructor() {
    super(
...
__name2(_allSettled, "_allSettled");
var Receiver = class _Receiver {
  static {
    __name(this, "_Receiver");
  }
  static {
    __name2(this, "Receiver");
  }
...
__name2(_generateEventId, "_generateEventId");
var Sender = class {
  static {
    __name(this, "Sender");
  }
...
__name2(_window, "_window");
function _setWindowLocation(url) {
  _window().location.href = url;
}
__name(_setWindowLocation, "_setWindowLocation");
__name2(_setWindowLocation, "_setWindowLocation");
function _isWorker() {
  return (
...
__name2(_getActiveServiceWorker, "_getActiveServiceWorker");
function _getServiceWorkerController() {
  return navigator?.serviceWorker?.controller || null;
}
__name(_getServiceWorkerController, "_getServiceWorkerController");
__name2(_getServiceWorkerController, "_getServiceWorkerController");
function _getWorkerGlobalScope() {
  return _isWorker() ? self : null;
}
__name(_getWorkerGlobalScope, "_getWorkerGlobalScope");
__name2(_getWorkerGlobalScope, "_getWorkerGlobalScope");
...
__name2(getObjectStore, "getObjectStore");
function _deleteDatabase() {
  const request = indexedDB.deleteDatabase(DB_NAME2);
  return new DBPromise(request).toPromise();
}
__name(_deleteDatabase, "_deleteDatabase");
__name2(_deleteDatabase, "_deleteDatabase");
...
__name2(_openDatabase, "_openDatabase");
...
__name2(_deleteObject, "_deleteObject");
...
var IndexedDBLocalPersistence = class {
  ...
  static {
    __name2(this, "IndexedDBLocalPersistence");
  }
  constructor() {
    this.type = "LOCAL";
    this.dbPromise = null;
...
__name2(startSignInPhoneMfa, "startSignInPhoneMfa");
...
__name2(finalizeSignInPhoneMfa, "finalizeSignInPhoneMfa");
...
__name2(finalizeSignInTotpMfa, "finalizeSignInTotpMfa");
  ...
  try {
    ...
    if ("session" in phoneInfoOptions) {
      ...
      if ("phoneNumber" in phoneInfoOptions) {
        ...
        const startEnrollPhoneMfaActionCallback = /* @__PURE__ */ __name2(
        ...
        const startSignInPhoneMfaActionCallback = /* @__PURE__ */ __name2(
          async (authInstance, request) => {
      ...
      const sendPhoneVerificationCodeActionCallback = /* @__PURE__ */ __name2(
        async (authInstance, request) => {
...
__name2(_verifyPhoneNumber, "_verifyPhoneNumber");
...
__name2(injectRecaptchaV2Token, "injectRecaptchaV2Token");
var PhoneAuthProvider = class _PhoneAuthProvider {
  static {
    __name(this, "_PhoneAuthProvider");
  }
  static {
    __name2(this, "PhoneAuthProvider");
  }
  /**
...
__name2(_withDefaultResolver, "_withDefaultResolver");
var IdpCredential = class extends AuthCredential {
  static {
    __name(this, "IdpCredential");
  }
  static {
    __name2(this, "IdpCredential");
  }
  constructor(params) {
    super(
      "custom",
...
var AbstractPopupRedirectOperation = class {
  ...
  static {
    __name2(this, "AbstractPopupRedirectOperation");
  }
...
var PopupOperation = class _PopupOperation extends AbstractPopupRedirectOperation {
  static {
    __name(this, "_PopupOperation");
  }
  static {
    __name2(this, "PopupOperation");
  }
...
__name2(_getAndClearPendingRedirectStatus, "_getAndClearPendingRedirectStatus");
function _overrideRedirectResult(auth, result) {
  redirectOutcomeMap.set(auth._key(), result);
}
__name(_overrideRedirectResult, "_overrideRedirectResult");
__name2(_overrideRedirectResult, "_overrideRedirectResult");
function resolverPersistence(resolver) {
  return _getInstance(resolver._redirectPersistence);
}
__name(resolverPersistence, "resolverPersistence");
__name2(resolverPersistence, "resolverPersistence");
...
__name2(pendingRedirectKey, "pendingRedirectKey");
...
__name2(_getRedirectResult, "_getRedirectResult");
...
__name2(isRedirectEvent, "isRedirectEvent");
async function _getProjectConfig(auth, request = {}) {
  return _performApiRequest(auth, "GET", "/v1/projects", request);
}
__name(_getProjectConfig, "_getProjectConfig");
__name2(_getProjectConfig, "_getProjectConfig");
...
__name2(_validateOrigin, "_validateOrigin");
...
__name2(matchDomain, "matchDomain");
...
__name2(resetUnloadedGapiModules, "resetUnloadedGapiModules");
function loadGapi(auth) {
  return new Promise((resolve, reject) => {
    ...
    __name2(loadGapiIframe, "loadGapiIframe");
...
__name2(getIframeUrl, "getIframeUrl");
  ...
  return context.open(
    ...
    (iframe) =>
      new Promise(async (resolve, reject) => {
        ...
        __name2(clearTimerAndResolve, "clearTimerAndResolve");
...
__name2(_openIframe, "_openIframe");
...
__name2(openAsNewWindowIOS, "openAsNewWindowIOS");
...
__name2(_getRedirectUrl, "_getRedirectUrl");
...
__name2(getHandlerBase, "getHandlerBase");
...
var BrowserPopupRedirectResolver = class {
  ...
  static {
    __name2(this, "BrowserPopupRedirectResolver");
  }
  constructor() {
    this.eventManagers = {};
    this.iframes = {};
...
var MultiFactorAssertionImpl = class {
  ...
  static {
    __name2(this, "MultiFactorAssertionImpl");
  }
...
var PhoneMultiFactorAssertionImpl = class _PhoneMultiFactorAssertionImpl extends MultiFactorAssertionImpl {
  static {
    __name(this, "_PhoneMultiFactorAssertionImpl");
  }
  static {
    __name2(this, "PhoneMultiFactorAssertionImpl");
  }
...
var PhoneMultiFactorGenerator = class {
  ...
  static {
    __name2(this, "PhoneMultiFactorGenerator");
  }
  constructor() {}
  /**
...
var TotpMultiFactorGenerator = class {
  ...
  static {
    __name2(this, "TotpMultiFactorGenerator");
  }
  /**
...
var TotpMultiFactorAssertionImpl = class _TotpMultiFactorAssertionImpl extends MultiFactorAssertionImpl {
  static {
    __name(this, "_TotpMultiFactorAssertionImpl");
  }
  static {
    __name2(this, "TotpMultiFactorAssertionImpl");
  }
...
var TotpSecret = class _TotpSecret {
  static {
    __name(this, "_TotpSecret");
  }
  static {
    __name2(this, "TotpSecret");
  }
...
__name2(_isEmptyString, "_isEmptyString");
...
__name2(getVersionForPlatform, "getVersionForPlatform");
...
__name2(getScriptParentElement, "getScriptParentElement");
...
__name2(isDiaDeTrabalho, "isDiaDeTrabalho");
...
function pages_template_plugin_default(pluginArgs) {
  const onRequest2 = /* @__PURE__ */ __name2(async (workerContext) => {
    ...
    const pluginNext = /* @__PURE__ */ __name2(async (input, init) => {
      if (input !== void 0) {
        let url2 = input;
...
__name(pages_template_plugin_default, "pages_template_plugin_default");
__name2(pages_template_plugin_default, "default");
